...
ActiveRecord::Schema.define(version: 20160606202534) do
  ...
  add_index "kubernetes_job_docs", ["build_id"], name: "index_kubernetes_job_docs_on_build_id", using: :btree
  ...
  add_index "kubernetes_job_docs", ["kubernetes_task_id"], name: "index_kubernetes_job_docs_on_kubernetes_task_id", using: :btree
  ...
  add_index "kubernetes_jobs", ["build_id"], name: "index_kubernetes_jobs_on_build_id", using: :btree
  add_index "kubernetes_jobs", ["kubernetes_task_id"], name: "index_kubernetes_jobs_on_kubernetes_task_id", using: :btree
  add_index "kubernetes_jobs", ["project_id"], name: "index_kubernetes_jobs_on_project_id", using: :btree
